...
(critério do pesquisador: 3 rodadas consecutivas limpas; rodadas 1-3
aplicadas 2026-08-10/11, ver `CRITIQUE.md` para o histórico completo).
5 páginas, compila limpo. Split de `01-syracuse-qx1-endogenia/main.tex`
