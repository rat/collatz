...
(\star2) & \liminf_\ell g_\ell(k_\ell,a)/\overline g_\ell(k_\ell)\ge\mu_1,
  \text{ uniformly over }a\in\mathbb N;\\
...
coefficient matching Berg--Krüppel's own asymptotic $\varphi_0$. This
...
A microcanonical decomposition connects Wirsching's generators
$g_\ell(k,a)$ to the Syracuse law $\mu_\ell$ directly.
