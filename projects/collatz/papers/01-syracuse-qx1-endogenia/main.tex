...
\cite{Nerman1981} would need holds here regardless, since $\log
q/\log2$ is irrational for every $q\ge3$.
\end{proposition}
...
-\tfrac37$ (verified in
\texttt{collatz-endogeny/sec4-endogeny-barrier/}) --- confirming,
under this specific weighting, that the net coarse contribution is
\emph{negative} and non-negligible in sign, consistent with, though we
stop short of claiming to fully derive, the observed negative sign of
the residual excess in \S\ref{sec:calibration}. (This does not by
itself establish that the calibration experiment's Arm~2 coupling
family is weighted this same way; see the scoping remark in
