...
Mahler1968,FlattoLagariasPollington1995,Erdos1979,Lagarias2009} were
obtained and verified directly (in particular, the precise Z-number
definition attributed to \cite{Mahler1968} and the attribution of the
1979 conjecture to \cite{Erdos1979} both matched exactly). One
citation, \cite{Halasz1977}, remains genuinely pending: the year
originally attached to it by the AI consultation (1977) was itself
wrong (the correct year is 1971), and the source we obtained while
correcting this turned out to be a 1972 erratum/remarks note by the
same author, not the primary 1971 paper, which we still do not have in
hand. We flag \cite{Halasz1977} accordingly and recommend a reader
verify it independently before relying on it; we consider this episode
good evidence for why this verification pass was worth doing. We
follow, in this disclosure,
...
\bibitem{GoncalvesGreenfeldMadrid2022} J.\ B.\ Gon\c{c}alves, R.\
  Greenfeld, and J.\ Madrid, \emph{On generalized Collatz maps and
  positive density of divergent orbits} (2022). [Bibliographic entry
  pending final verification against the published version; see
  Acknowledgments.]
...
\bibitem{Bremont} J.\ Br\'emont, \emph{Self-similar measures and the
  Rajchman property}, Annales Henri Lebesgue. [Bibliographic entry
  pending final verification of volume/pages; see Acknowledgments.]
...
\bibitem{Halasz1977} G.\ Hal\'asz, \emph{On the distribution of
  ...
  (1971), 211--233. [Primary source not yet in hand; only a related
  1972 erratum/remarks note by the same author has been obtained and
