...
require a pre-registered comparison against alternative tail models
(in particular a log-periodic fit, given that the branch weights are
powers of $2$) on a much larger computational budget than exhaustive
population enumeration allows; an analytic handle on the linear
transfer operator's spectrum, once obtained, turned out not to bear on
this question, since the transient lives in a separate nonlinear
layer. We list it as an explicit open problem
