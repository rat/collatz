...
(Proposition~\ref{prop:always-frozen}), quenched-equals-annealed growth
holds throughout the unfrozen region \cite{Biggins1992}, and almost
surely: $N(x)\sim x$ at $q=3$ (positive density, since $\alpha_-(3)=1$
exactly); $N(x)\sim W_u\cdot x^{\alpha_-(q)}$ for some a.s.\ positive
random scale factor $W_u$, for every odd $q\ge5$ ($\alpha_-(q)<1$).
\end{theorem}
...
already settled in \S\ref{sec:regimes}. We have since pursued exactly
