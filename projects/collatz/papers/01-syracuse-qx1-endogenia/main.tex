...
conjecture's own cost window falls short of what $\beta=1$ needs. We
prove Wirsching's first 2003 conjecture on the base-$3$ Fabius
function, and test the third to certified numerical error; a companion
paper treats the second, with a corrected reading of its actual target
\cite{WirschingCompanion}. Two candidate lemmas from Tao's bivariate
...
related cost in Tao's $\beta=1$ conjecture; \S\ref{sec:triangulation}
also proves Wirsching's first 2003 conjecture, with the third tested
numerically and the second treated in a companion paper
\cite{WirschingCompanion}. Section~\ref{sec:kl} restates a companion
...
Wirsching~\cite{Wirsching2003}, developed in full in a companion paper
\cite{WirschingCompanion}, whose central combinatorial object, the
...
\item \emph{Worst-cylinder cascade factor}
  ...
  R_\ell(u)$ itself is proved, not merely checked at these levels.
