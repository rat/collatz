...
\item \textbf{Absolute continuity and the tail index of the tilted
  ...
  normalization exponent) found no artifact behind this reading. The
  conjecture is strongly supported for $q=5$, though not proved: the
  Vuong test yields non-rejection rather than confirmation, and the
  finite-depth factors remain pre-asymptotic at the headroom reached
  (their median continues to drift with headroom even as the
  estimated tail index does not).
