...
zero natural density of the reverse tree (for $q=3$, implying and
strictly refining the classical Growth Exponent Conjecture of
Kontorovich--Lagarias and Applegate--Lagarias, since our conjecture also
fixes the limiting constant, not merely the exponent). We show,
...
an explicit conjecture, now substantially strengthened by a large-sample
...
Bremont}, showing it is structurally inaccessible to that toolkit
because of the rigidity of closed subgroups of $\mathbb{Z}_3^\times$,
and identifies a fifth, purely combinatorial and independently
testable, vocabulary for the same obstruction in very recent work
\cite{Chang2026}. We argue that this convergence of five methodologically independent
...
If $W_u=\lim_k Z_k(\theta;u)$ has tail index
