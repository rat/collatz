...
transition at $q\ge5$ is new: Wirsching conjectured the transition
heuristically in 1998 \cite{Wirsching1998}, and Kontorovich--Lagarias
had already computed the same quantity (their $\eta_{5,BP}$, Theorem
8.10) via large-deviations methods for a branching random walk, a
route different from, but numerically identical to, the pressure-equation
...
and the discussion above show that stronger claim would be imprecise.
...
2003 results restated in \S\ref{sec:triangulation}
(Theorem~\ref{thm:wirsching-conj1},
Theorem~\ref{thm:microcanonical},
