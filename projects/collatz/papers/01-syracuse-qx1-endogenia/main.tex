...
(\star4) & \liminf_\ell(W_3^\ell\chi_1)(x_\ell)/(W_3^\ell\chi_0)(x_\ell)
  \ge\mu\text{, uniformly for }(x_\ell)\in\widetilde A_\delta,\\
 & \text{with }\chi_0=\mathbf1_{[0,2/3]},\ \chi_1=\mathbf1_{[1/3,1]};\\
...
$\varphi(z_\ell)/\varphi_0(z_\ell)$ tested numerically below.
...
$\ell=500$ (error certified $\le10^{-8}$).
...
residual-coupling experiment of \S\ref{sec:calibration}, the Weak
Covering Conjecture test of \S\ref{sec:wcc}, the $K_\ell$/Jensen
computations, the Chang residue-balance test, and the checks for
Lemma~\ref{lem:2adic}, Theorem~\ref{thm:wcc-large-deviation},
