...
concordância alegada). Não temos conhecimento de nenhum outro teste
empírico direto da Conjectura~\ref{conj:tail-index} para $q\ge5$, e a
...
\item \textbf{O índice de cauda do fator de escala do martingale}
  ...
  empírico sólido (a única medição existente, para $q=5$, já foi
  mostrada ser estatisticamente não-confirmatória). Esta é,
