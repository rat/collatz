...
atingiu. Dada a taxa de convergência lenta já estabelecida para $q=5$
(uma raiz complexa subdominante dando decaimento $k^{-0{,}222}$,
\S\ref{sec:freezing}), o transiente decai só cerca de $7\%$ entre
...
resolvê-la provavelmente exigirá ou um controle analítico sobre o
espectro subdominante do operador de transferência, ou uma comparação
pré-registrada contra modelos alternativos de cauda com um orçamento
computacional muito maior do que a enumeração populacional exaustiva
permite. Listamos isso como problema em aberto explícito na
