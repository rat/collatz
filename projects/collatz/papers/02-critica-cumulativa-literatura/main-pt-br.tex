...
que define o catálogo irmão. Erros genuínos ocorrem --- dois num
programa de sete papers de um único autor prolífico, um num resultado
autônomo por outro lado cuidadoso --- mas se distribuem de forma
diferente: os erros do autor prolífico são ambos inconsistências entre
enunciado e demonstração, contidas a uma única seção cada; o erro do
resultado autônomo está no seu teorema titular. Esta nota é
...
separado de literatura de referência estabelecida (o teorema de quase-
todas-as-órbitas de Tao, o modelo estocástico de Kontorovich--Lagarias
