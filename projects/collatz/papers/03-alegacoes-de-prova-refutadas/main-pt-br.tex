...
cada caso --- o argumento reconstruído exato, a verificação
computacional e, quando aplicável, o código-fonte --- fica nos arquivos
de caso individuais referenciados na Seção~\ref{sec:taxonomy}; esta
nota resume esse material, não o reproduz.
