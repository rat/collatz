...
taxonomy of the ways they fail: three categories jointly account for
ten of the twelve cases --- circular reasoning that smuggles the
conjecture's conclusion into a definition or premise (three cases),
illegitimate generalization from one hand-picked adversarial sequence
to all sequences (two cases), and a single recurring fallacy, treating
an aggregate, average, or asymptotic property as a deterministic,
pointwise guarantee for one specific trajectory, that by itself
accounts for the remaining five (disguised in turn by Baker's theorem,
a random-walk heuristic, a 2-adic Lyapunov argument, Big-O notation,
and static 2-adic density). The remaining two cases are an elementary error
...
the exact reconstructed argument and the computational check --- was
recorded during this review in internal working notes; this note
summarizes that material rather than reproducing it in full.
...
concentration: five of the twelve cases, despite using entirely
...
pointwise guarantee, and five more commit one of two closely related
