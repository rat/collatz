...
- **15 PDFs baixados** com sucesso (arquivo local na tabela) — hosts que
  permitiram download direto: arXiv, github.io, engrxiv.org, dergipark.org.tr,
  rxiverse.org, osf.io, usac.edu.gt, science.lpnu.ua.
- **~76 sem PDF livre**, majoritariamente porque o host bloqueia download
  automatizado (ver "Limitações técnicas" abaixo) — **não** porque o
  conteúdo é necessariamente pago; muitos são ResearchGate, que costuma
  ter o PDF do autor hospedado mas exige navegação humana para acessar.
...
|---|---|---|---|---|---|---|---|
| 001 | Geometría Residual de Ruiz Castillo para la dinámica acelerada de la Conjetura de Collatz | SDJCR Castillo - researchgate.net | [link](https://www.researchgate.net/profile/Juan-Carlos-Ruiz-3/publication/408622365_Geometria_Residual_de_Ruiz_Castillo_para_la_dinamica_acelerada_de_la_Conjetura_de_Collatz) | sem PDF livre (lido via navegador, ver `hypotheses/H-039...md`) | Sim | Sim | Parcial |
| 002 | Behavior of a Decimal-Parity-Based 3n+1 Mapping | J Adnan, SA Dar - Global Journal of Pure and Applied, 2026 | [link](https://www.researchgate.net/profile/Showkat-Dar-3/publication/408579654_Behavior_of_a_Decimal-Parity-Based_3n_1_Mapping) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 003 | A Collatz-Equivalent Map on the Nonzero Integers | JS Gilbert - 2026 - preprints.org | [link](https://www.preprints.org/manuscript/202607.0575) | sem PDF livre (preprints.org bloqueia via Akamai) |  |  |  |
| 004 | First-Principles Derivation of the Steiner Sentence Length Distribution | J Seymour - 2026 - wildducktheories.github.io | [link](https://wildducktheories.github.io/collatz/papers/67-branch-length-distribution/67-branch-length-distribution.pdf) | `004_First-Principles-Derivation-Steiner-Sentence-Length-Distribution.pdf` |  |  |  |
| 005 | A Regular Expression Language for the Collatz Graph | J Seymour - 2026 - wildducktheories.github.io | [link](https://wildducktheories.github.io/collatz/papers/33-architecture/33-architecture.pdf) | `005_A-Regular-Expression-Language-for-the-Collatz-Graph.pdf` |  |  |  |
| 006 | A Two-Field Propagation Model for the Collatz Map | MM Anthony - 2026 - researchgate.net | [link](https://www.researchgate.net/profile/Michael-Anthony-9/publication/408534749) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 007 | Finite-Dimensional Combinatorial and Arithmetic Structures of Parity Vectors for the Accelerated Collatz Map | K Hikawa - researchgate.net | [link](https://www.researchgate.net/profile/Kazunobu-Hikawa/publication/408442963) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 008 | Dissipative Bounds and Ruiz Castillo Residual Decomposition in the Accelerated Dynamics of the Collatz Conjecture | SDJCR Castillo - researchgate.net | [link](https://www.researchgate.net/profile/Juan-Carlos-Ruiz-3/publication/408442850) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 009 | Structural Dualism in Integer Architectures | E Olgac - researchgate.net | [link](https://www.researchgate.net/profile/Enis-Olgac/publication/408474319) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 010 | Teorema Central del Límite Residual de Ruiz Castillo para la dinámica acelerada de la Conjetura de Collatz | SDJCR Castillo - researchgate.net | [link](https://www.researchgate.net/profile/Juan-Carlos-Ruiz-3/publication/408441825) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 011 | Structural Analysis, Dynamic Density Sieve, and Logarithmic Contraction of Collatz Sequences | A Mohammed - 2026 - researchgate.net | [link](https://www.researchgate.net/profile/Abdullah-Mohamed-23/publication/408468717) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
...
| 013 | Operador de Transferencia Residual de Ruiz Castillo y estructura espectral en la dinamica acelerada de la Conjetura de Collatz | SDJCR Castillo - researchgate.net | [link](https://www.researchgate.net/profile/Juan-Carlos-Ruiz-3/publication/408302965) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 014 | A Coordinate System for Collatz Dynamics | J Williams - arXiv:2607.01718, 2026 | [link](https://arxiv.org/abs/2607.01718) | `014_A-Coordinate-System-for-Collatz-Dynamics.pdf` |  |  |  |
| 015 | Canonical Shells and Residue-Cover Trees in a Conditional First-Descent Approach to the Collatz Problem | SY Kayadibi - researchgate.net | [link](https://www.researchgate.net/profile/Seyma-Yaman-Kayadibi/publication/408305072) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 016 | Collatz-Thwaites-Ulam-Hasse-Syracuse-Kakutani (CTUHSK) Theorem | KP Bikarnakatte - engrxiv.org | [link](https://engrxiv.org/preprint/download/6063/version/9608/12114/10446) | `016_CTUHSK-Theorem.pdf` |  |  |  |
| 017 | Medidas de Gibbs Residuales de Ruiz Castillo y estados de equilibrio en la dinamica acelerada de la Conjetura de Collatz | SDJCR Castillo - researchgate.net | [link](https://www.researchgate.net/profile/Juan-Carlos-Ruiz-3/publication/408180601) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
...
| 019 | Emergence of Gamma-Type Upward-Phase Statistics in the Collatz Map: An Effective Poisson Process Mechanism | W Fu, X Liu, Y Wang - arXiv:2606.26811, 2026 | [link](https://arxiv.org/abs/2606.26811) | `018_Emergence-of-Gamma-Type-Upward-Phase-Statistics.pdf` |  |  |  |
| 020 | Principio Variacional Residual de Ruiz Castillo y formalismo termodinamico para la dinamica acelerada de la Conjetura de Collatz | SDJCR Castillo - 2026 - researchgate.net | [link](https://www.researchgate.net/profile/Juan-Carlos-Ruiz-3/publication/407719073) | sem PDF livre (ResearchGate bloqueia download automatizado) |  |  |  |
| 021 | A GENERALIZATION OF 3x+1 PROBLEM TO 3x+4y+1 | R Amirian, A Amirian - SSRN 6993335 | [link](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6993335) | sem PDF livre (nenhum link PDF listado pelo Scholar) |  |  |  |
...
| 028 | A Continuous Multi-Component Measure of Directed Acyclicity (DAG-ness) | E Csikos - arXiv:2606.22205, 2026 | [link](https://arxiv.org/abs/2606.22205) | `027_Continuous-Multi-Component-Measure-DAG-ness.pdf` |  |  |  |
| 029 | Collatz Progressions Reframed: Exponent Representation, Algorithmic Hierarchies, and Record Computations | N Alic - IEEE Access, 2026 | [link](https://ieeexplore.ieee.org/document/11569889) | sem PDF livre (IEEE Xplore bloqueia, paywall) |  |  |  |
...
| 031 | Predicting extreme stopping time behavior in the Collatz system | E Melas, NC Poulios - Journal of Dynamics and Games, 2026 - aimsciences.org | [link](https://www.aimsciences.org/article/doi/10.3934/jdg.2026037) | sem PDF (disponivel em HTML no site da revista, nao baixavel como PDF direto) |  |  |  |
| 032 | Jacobsthal Trees and Generalized Transformations | P Kosobutskyy, D Mailland - dergipark.org.tr | [link](https://dergipark.org.tr/en/download/article-file/5786597) | `032_Jacobsthal-Trees-Generalized-Transformations.pdf` |  |  |  |
...
| 036 | Upper bounds for the Laplacian spectral radius: Proofs and counterexamples | I Damnjanovic, T Ha, D Stevanovic - arXiv:2606.14550, 2026 | [link](https://arxiv.org/abs/2606.14550) | `036_Upper-bounds-Laplacian-spectral-radius.pdf` |  |  |  |
...
| 038 | A modular classification of pre-descent resistance in accelerated odd Collatz dynamics | SY Kayadibi - SSRN 6918258, 2026 | [link](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6918258) | sem PDF livre (SSRN bloqueou download, 403) |  |  |  |
...
| 049 | The Collatz Conjecture is True [ALEGAÇÃO DE PROVA - ver nota] | DG Boyle - 2026 - rxiverse.org | [link](https://rxiverse.org/abs/2606.0019) | `049_The-Collatz-Conjecture-is-True.pdf` |  |  |  |
...
| 055 | Platonismo y realismo en matematicas y fisica: un estudio ontologico y epistemologico | JCR Castillo, AFM Sanabria - Diotima, 2026 - usac.edu.gt | [link](https://revistasguatemala.usac.edu.gt/diotima/article/download/4108/3828) | `055_Platonismo-realismo-matematicas-fisica.pdf` |  |  |  |
...
| 057 | A Fibonacci theorem for Collatz trajectories via modular graph structure | MAR Jimenez - arXiv:2606.02621, 2026 | [link](https://arxiv.org/abs/2606.02621) | `056_Fibonacci-theorem-Collatz-modular-graph.pdf` |  |  |  |
...
| 074 | Loop Termination and Generalized Collatz Sequences | M Carelli - arXiv:2605.15094, 2026 | [link](https://arxiv.org/abs/2605.15094) | `073_Loop-Termination-Generalized-Collatz.pdf` |  |  |  |
...
| 076 | A Structural Proof of the Collatz Conjecture via non-repeating trajectory and Recursive Decay [ALEGAÇÃO DE PROVA] | YH Yun - osf.io | [link](https://osf.io/) | `075_Structural-Proof-Collatz-nonrepeating.pdf` |  |  |  |
...
| 084 | MODELLING THE COLLATZ PROBLEM FROM A JACOBSTHAL VIEWPOINT | D Mailland, P Kosobutskyy - 2026 - lpnu.ua | [link](https://science.lpnu.ua/sites/default/files/journal-paper/2026/apr/42255/20265.pdf) | `084_Modelling-Collatz-Jacobsthal-Viewpoint.pdf` |  |  |  |
...
| 099 | Selection Rules and Channel Structure in a Base Octave Model of Collatz Dynamics | K Lodders - arXiv:2604.20181, 2026 | [link](https://arxiv.org/abs/2604.20181) | `098_Selection-Rules-Channel-Structure-Base-Octave.pdf` |  |  |  |
