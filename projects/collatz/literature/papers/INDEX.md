...
| 145 | On generalized multiplicative cascades [verificação bibliográfica para H-132 - Teorema 2.2 (p. 270) conferido letra por letra contra as quatro condições e a conclusão citadas em H-132/`thm:iid-tail`; sem discrepância] | Q Liu - Stochastic Processes and their Applications 86(2), 263-286, 2000 | BAIXADO (pelo diretor científico, 2026-08-08, DOI 10.1016/S0304-4149(99)00097-6) | `145_Liu-2000-On-Generalized-Multiplicative-Cascades.pdf` | Sim | Sim | N/A |
| 146 | Implicit renewal theorem for trees with general weights [verificação bibliográfica para H-132 - trata da recursão aditiva R=ΣC_iR_i+Q com pesos reais quaisquer; confirma que H-132 a cita corretamente como referência tangencial, não como base do argumento] | PR Jelenković, M Olvera-Cravioto - Stochastic Processes and their Applications 122(9), 3209-3238, 2012 | BAIXADO (pelo diretor científico, 2026-08-08, DOI 10.1016/j.spa.2012.05.004) | `146_Jelenkovic-Olvera-Cravioto-2012-Implicit-Renewal-Theorem-Trees.pdf` | Sim | N/A | N/A |
| 147 | Branching random walk conditioned on large martingale limit [verificação bibliográfica para H-132 - Assumption 1-4 (p. 2) e a fórmula de cauda (1.4) atribuídas ao Teorema 2.2 de Liu (2000) batem exatamente com a leitura de H-132, confirmação independente] | X Chen, L de Raphélis, H Ma - arXiv:2408.05538, 2024 | BAIXADO (pelo diretor científico, 2026-08-08, DOI 10.48550/arXiv.2408.05538) | `147_Chen-de-Raphelis-Ma-2024-Branching-Random-Walk-Martingale-Limit.pdf` | Sim | N/A | N/A |
| 148 | Convergence of weighted branching processes [verificação bibliográfica para o paper 06 (crítica C-22) - o próprio texto citava "may already contain it, but we have not verified this" para a assíntota fina N(x)~W·x^α; leitura confirma que o preprint só estende convergência de martingala geração-a-geração (mesmo escopo de Biggins 1992) a espaços de tipo gerais e pesos não-geométricos, sem nenhuma máquina de renovação/CMJ; não cobre a lei somada-sobre-gerações que prop:transition-fine precisa. Corrigido no texto] | D Villemonais, N Zalduendo - arXiv:2512.07653, 2025 | BAIXADO (pelo assistente, 2026-08-10, com autorização explícita do diretor científico para baixar PDFs de citações a partir desta data) | `148_Villemonais-Zalduendo-2025-Convergence-Weighted-Branching-Processes.pdf` | Sim | Sim | N/A |
| 149 | A probabilistic model for the 5x+1 problem and related maps [verificação bibliográfica para o paper 04 (crítica rodada R4) - toda alegação de conteúdo sobre Volkov no paper 04 vinha só da paráfrase de Kontorovich-Lagarias; leitura direta confirma: modela contagem de trajetórias não-divergentes Q(x) que entram em algum ciclo (conjectura de só três ciclos), árvore binária completa com codificação incomum dos iterados, publicado em Stochastic Processes and their Applications 116(4), 2006, 662-674 (a bibliografia de KL erra o título duas vezes, "5k+1" e "related problems", e o nome do periódico, sem "their"; não erram o fascículo, só o omitem; o `\bibitem` do paper 04 está correto)] | S Volkov - preprint 30 set 2005 (revisado 2x), publicado SPA 116(4), 2006 | BAIXADO (pelo assistente, 2026-08-11, mesma autorização do item 148) | `149_Probabilistic-Model-5x1-Problem-Related-Maps-Volkov.pdf` | Sim | Sim | N/A |
